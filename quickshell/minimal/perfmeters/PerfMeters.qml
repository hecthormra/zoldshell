...
Scope {
    ...
    PanelWindow {
        ...
        property real globalScale: 0.85

        // Main panel size
        property int mywidth: 200
        property int containerWidth: mywidth - 16
        property int widgetRadius: 8

        // Set Network device
        property string netDev: "enp3s0"
        ...
        property string widgetBGcolor: root.theme.bgSurface         // #AARRGGBB
        property string widgetBorderColor: root.theme.bgBorder
        property int widgetSpacing: 4
        property int cpuSpacing: 1
        property int graphHeight: 34
