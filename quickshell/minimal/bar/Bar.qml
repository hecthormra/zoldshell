          ...
          Row {
            ...
            Repeater {
              ...
              Rectangle {
                ...
                MouseArea {
                  anchors.fill: parent
                  onClicked: sway.switchWorkspace(wsPill.modelData.name)
                }
          ...
          Row {
            ...
            Rectangle {
              ...
              MouseArea {
                ...
                onClicked: {
                  console.log("TEMPERATURA CLICADA")
                  console.log("SettingsWindow:", root.settingsWindow)

                  if (root.settingsWindow)
                    root.settingsWindow.visibleSettings = true
                }
              }
            }
          }
