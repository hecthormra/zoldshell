...
Singleton {
    ...
    var active1 = hexToRgba(t.accentPrimary);
    var active2 = hexToRgba(t.accentCyan);
    var inactive = hexToRgba(t.bgBorder);

    hyprlandProc.command = [
        "sh",
        "-c",
        'cat > "$HOME/.config/hypr/config/theme.lua" <<EOF\n' +
        'return {\n' +
        '    active_border_1 = "' + active1 + '",\n' +
        '    active_border_2 = "' + active2 + '",\n' +
